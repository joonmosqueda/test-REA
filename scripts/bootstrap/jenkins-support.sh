...
# DESCRIPTION
#
#   Contains a bunch of Jenkins helper utilities.
#
# KNOWN USAGES
#
#   Used by `install-plugins.sh` when creating the Jenkins AMI.
#
# AUTHOR
#
#    Jenkins <https://github.com/jenkinsci/docker/blob/master/jenkins-support>
